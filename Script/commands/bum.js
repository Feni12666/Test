...
const categories = [
 "cartoon","ornil_murgi","imran_murgi","afsuu_megi","my_free_fire",
 "priya_megi","foysal_murgi","couple","pori_megi","sex_video",
 "aesthetic","samanta_megi","akushi_megi","cat","18plus",
 "freefire","football","girl","friend","cricket"
];

const captions = {
 cartoon: "🤣 Cartoon video",
 ornil_murgi: "😇 Islamic video",
 imran_murgi: "🥺 Sad video",
 afsuu_megi: "😘 Anime video",
 my_free_fire: "😇 Free Fire video",
 priya_megi: "😇 Love video",
 foysal_murgi: "🥵 Adult video",
 couple: "❤️ Couple video",
 pori_megi: "🌸 Flower video",
 sex_video: "🎯 Marvel video",
 aesthetic: "🎀 Aesthetic video",
 samanta_megi: "🐤 Sigma video",
 akushi_megi: "🥰 Lyrics video",
 cat: "🐱 Cat video",
 "18plus": "🔞 18+ video",
...
module.exports.handleReply = async function ({ api, event, handleReply }) {
 ...
 // admin lock
 if ((selectedCategory === "foysal_murgi" || selectedCategory === "18plus") &&
